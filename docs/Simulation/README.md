...
#### Side-Effects:
New [SimAttributes](./../SimAttributes/README.md) Class is created
New [LogFile](./../LogFile/README.md) class is created with name: `Simulation.log`
`cerr` is redirected to a file within the folder structure above: `errors.log`
