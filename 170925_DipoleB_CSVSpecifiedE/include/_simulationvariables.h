...
constexpr double MAX_Z_SIM{ 5 * RADIUS_EARTH / NORMFACTOR }; //Max Z value of the simulation - same as above
...
constexpr double V_SIGMA_SQ_ELEC{ INITIAL_T_EV * 1.60218e-19 / (MASS_ELECTRON * NORMFACTOR * NORMFACTOR) }; //need this for cuda code
...
constexpr double V_SIGMA_SQ_IONS{ INITIAL_T_EV * 1.60218e-19 / (MASS_PROTON * NORMFACTOR * NORMFACTOR) };
